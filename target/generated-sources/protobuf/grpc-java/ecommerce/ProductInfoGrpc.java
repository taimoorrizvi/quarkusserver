...
public final class ProductInfoGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ecommerce.ProductInfoOuterClass.Product,
      ecommerce.ProductInfoOuterClass.ProductID> getAddProductMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "addProduct",
      requestType = ecommerce.ProductInfoOuterClass.Product.class,
      responseType = ecommerce.ProductInfoOuterClass.ProductID.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ecommerce.ProductInfoOuterClass.Product,
      ecommerce.ProductInfoOuterClass.ProductID> getAddProductMethod() {
    io.grpc.MethodDescriptor<ecommerce.ProductInfoOuterClass.Product, ecommerce.ProductInfoOuterClass.ProductID> getAddProductMethod;
      ...
      synchronized (ProductInfoGrpc.class) {
        if ((getAddProductMethod = ProductInfoGrpc.getAddProductMethod) == null) {
          ProductInfoGrpc.getAddProductMethod = getAddProductMethod =
              io.grpc.MethodDescriptor.<ecommerce.ProductInfoOuterClass.Product, ecommerce.ProductInfoOuterClass.ProductID>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ecommerce.ProductInfoOuterClass.ProductID.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ecommerce.ProductInfoOuterClass.ProductID,
      ecommerce.ProductInfoOuterClass.Product> getGetProductMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getProduct",
      requestType = ecommerce.ProductInfoOuterClass.ProductID.class,
      responseType = ecommerce.ProductInfoOuterClass.Product.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ecommerce.ProductInfoOuterClass.ProductID,
      ecommerce.ProductInfoOuterClass.Product> getGetProductMethod() {
    io.grpc.MethodDescriptor<ecommerce.ProductInfoOuterClass.ProductID, ecommerce.ProductInfoOuterClass.Product> getGetProductMethod;
    if ((getGetProductMethod = ProductInfoGrpc.getGetProductMethod) == null) {
      synchronized (ProductInfoGrpc.class) {
        if ((getGetProductMethod = ProductInfoGrpc.getGetProductMethod) == null) {
          ProductInfoGrpc.getGetProductMethod = getGetProductMethod =
              io.grpc.MethodDescriptor.<ecommerce.ProductInfoOuterClass.ProductID, ecommerce.ProductInfoOuterClass.Product>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public static abstract class ProductInfoImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getProduct(ecommerce.ProductInfoOuterClass.ProductID request,
  ...
  public static final class ProductInfoBlockingStub extends io.grpc.stub.AbstractBlockingStub<ProductInfoBlockingStub> {
    ...
    /**
     */
    public ecommerce.ProductInfoOuterClass.ProductID addProduct(ecommerce.ProductInfoOuterClass.Product request) {
    ...
    /**
     */
    public ecommerce.ProductInfoOuterClass.Product getProduct(ecommerce.ProductInfoOuterClass.ProductID request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ProductInfoFutureStub extends io.grpc.stub.AbstractFutureStub<ProductInfoFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ecommerce.ProductInfoOuterClass.ProductID> addProduct(
    ...
    public com.google.common.util.concurrent.ListenableFuture<ecommerce.ProductInfoOuterClass.Product> getProduct(
        ecommerce.ProductInfoOuterClass.ProductID request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_GET_PRODUCT:
          serviceImpl.getProduct((ecommerce.ProductInfoOuterClass.ProductID) request,
              (io.grpc.stub.StreamObserver<ecommerce.ProductInfoOuterClass.Product>) responseObserver);
          break;
        default:
